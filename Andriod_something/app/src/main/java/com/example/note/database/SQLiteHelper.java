...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    public boolean insertDate(String userContent, String userTime) {
        ...
        return sqLiteDatabase.insert(DBUtils.DATABASE_TABLE,
    ...
    public boolean deleteDate(String id) {
        ...
        return sqLiteDatabase.delete(DBUtils.DATABASE_TABLE,
    ...
    public boolean updateData(String id,String content,String userYear){
        ...
        return sqLiteDatabase.update(DBUtils.DATABASE_TABLE,contentValues,
                sql, strings)>0;
    }
    ...
    public List<NotepadBean> query(){
        ...
        if (cursor != null){
            while (cursor.moveToNext()){
                ...
                String id = String.valueOf(cursor
                        .getInt(cursor.getColumnIndex(DBUtils.NOTEPAD_ID)));
                String content = cursor
                        .getString(cursor.getColumnIndex(DBUtils.NOTEPAD_CONTENT));
                String time = cursor
                        .getString(cursor.getColumnIndex(DBUtils.NOTEPAD_TIME));
                noteInfo.setId(id);
